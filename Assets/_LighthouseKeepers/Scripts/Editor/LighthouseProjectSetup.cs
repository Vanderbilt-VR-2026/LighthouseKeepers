...
namespace LighthouseKeepers.Editor
{
    ...
    public static class LighthouseProjectSetup
    {
        ...
        static void ConfigureRendering()
        {
            ...
            settings.FindProperty("m_AdditionalLightsRenderingMode").intValue=2;
            ...
            for(int i=0;i<QualitySettings.names.Length;i++) {QualitySettings.SetQualityLevel(i);QualitySettings.renderPipeline=i==1 ? (AssetDatabase.LoadAssetAtPath<UniversalRenderPipelineAsset>(Root+"/Settings/RenderPipeline/EditorPreviewPipeline.asset") ?? rp) : rp;}
